...
\resizebox{\textwidth}{!}{\url{https://github.com/edasubert/quasicrystal/blob/master/RESULTS/RESULTS.zip}}
...
The columns of Table \ref{tab_tiles1} correspond to window sizes: 
\begin{multicols}{2}
\begin{enumerate}
\item $1$
...
The rows of Table \ref{tab_tiles1} correspond to the Voronoi tiles from Figure \ref{fig_tiles1}. 
